"""
Django settings for savia project.
...
SECRET_KEY = 'django-insecure-&iz8!3(8ezd3i1=i)crr^(-#wbx0l7nwn(-adr(*rz#m0)b@5i'
...
MIDDLEWARE = [
    ...
    'savia.middleware.LoginRequiredMiddleware'
]

ROOT_URLCONF = 'savia.urls'
...
WSGI_APPLICATION = 'savia.wsgi.application'
